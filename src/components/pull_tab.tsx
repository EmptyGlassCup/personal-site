    ...
    return(
        ...
        flex flex-col justify-center items-center`}>
            ...
            <svg className = "w-7"viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M14 12C14 10.3431 12.6569 9 11 9H5C3.34315 9 2 10.3431 2 12V15H14V12Z" fill="#0B3954"/>
            </svg>
            <p className = "font-mono text-xs text-[#0B3954]">about me</p>
        </div>
    )
}