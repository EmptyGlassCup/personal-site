...
function App(){
  ...
  return (
    ...
    duration-100`}>
      ...
      <svg onClick={toggleDark} className='absolute right-0 bottom-0 w-15 -translate-x-5 -translate-y-5 fill-[#212529] dark:fill-[#3dccc7] hover:w-16 transition-width duration-100 ease-in-out' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
